                   ...
                   const string path = "./")
{
  ...
  int ptBins = 50, chi2Bins = 75;

  TH1F *cpuPt = nullptr, *cudaPt = nullptr, *hipPt = nullptr, *gpuWfPt=nullptr;
  TH1F *cpuChi2 = nullptr, *cudaChi2 = nullptr, *hipChi2 = nullptr, *gpuWfChi2=nullptr;
  ...
  if (gpuWfFile) {
    gpuWfPt = new TH1F("gpuWfPt", "GPU WF track #it{p}_{T};#it{p}_{T} (GeV);counts", ptBins, xbins);
    gpuWfPt->Sumw2();
    gpuWfChi2 = new TH1F("gpuWfChi2", "GPU WF track #chi^{2};#chi^{2};counts", chi2Bins, chi2Min, chi2Max);
